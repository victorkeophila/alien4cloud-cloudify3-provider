...
env_map['VOLUME_ID'] = ''
env_map['DEVICE'] = get_nested_attribute(ctx.target, ['volumes', 'CBS3', 'device_name'])
other_instances_map = _all_instances_get_nested_attribute(ctx.target, ['volumes', 'CBS3', 'device_name'])
